...
import { ITEMS, type State } from "@/lib/island/game";
...
export function WordBook({
  ...
  const { concepts } = useLearningModel();
  ...
  for (const concept of concepts) {
    if (concept.languageCode === "sv" && !entries.has(concept.canonicalForm))
      entries.set(concept.canonicalForm, {
        key: "course:" + concept.id,
        sv: concept.canonicalForm,
        en: concept.gloss,
        forms: concept.description ?? "From your Sapling course",
        example: "",
        translation: "",
      });
  }
